...
# def upload_contact_image(file: UploadFile=File(...)):
#     pass
...
def edit_contact(contact_id: int, edit, user_id, db: Session):
    ...
    contact.update(edit.model_dump(), synchronize_session=False)
    db.commit()
